...
INSERT INTO "new_transactions" ("amount", "appointmentId", "clientId", "companyId", "createdAt", "description", "id", "paymentMethod", "productId", "status", "type", "updatedAt") SELECT "amount", "appointmentId", "clientId", "companyId", "createdAt", "description", "id", "paymentMethod", "productId", "status", "type", "updatedAt" FROM "transactions";
